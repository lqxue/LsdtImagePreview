...
import com.workleshuadailypreview.wight.BezierBannerView;
import com.workleshuadailypreview.wight.PhotoViewPager;
...
public class GPreviewActivity extends FragmentActivity {
    ...
    private void initData() {
        imgUrls = (List<IThumbViewInfo>) getIntent().getSerializableExtra("imagePaths");
